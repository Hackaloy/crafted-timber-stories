        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg mb-6 leading-relaxed">
              At WoodWorks Studio, we believe that every piece of timber has a story to tell. Founded in 2010, our boutique carpentry studio has been dedicated to creating bespoke wooden furnishings that blend traditional craftsmanship with contemporary design.
            </p>
